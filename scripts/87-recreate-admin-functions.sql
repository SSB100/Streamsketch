-- This script creates the admin functions with the final, correct logic.
-- Run this script ONLY after successfully running 86-drop-admin-functions.sql.
...
CREATE FUNCTION public.admin_withdraw_revenue()
...
CREATE FUNCTION public.update_transaction_details(p_transaction_id uuid, p_signature text, p_fee numeric)
RETURNS void
LANGUAGE plpgsql
AS $$
DECLARE
