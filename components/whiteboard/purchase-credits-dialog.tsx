...
export function PurchaseCreditsDialog({ isOpen, onOpenChange, onPurchaseSuccess }: PurchaseCreditsDialogProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onOpenChange}>
      <DialogContent className="max-w-3xl border-border/40 bg-deep-space">
        <DialogHeader>
          <DialogTitle className="text-white">Purchase Line Credits</DialogTitle>
          <DialogDescription>Top up your account to keep the creativity flowing.</DialogDescription>
        </DialogHeader>
